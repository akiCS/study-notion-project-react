  ...
  return (
    ...
    <div className='flex w-11/12 max-w-[1160px] py-12 mx-auto gap-x-12 gap-y-0 justify-between'>
        ...
        <div className='relative w-11/12 max-w-[450px]'>
            <img src={framImage} alt='pattern' width={558} height={504} loading='lazy'></img>

            <img src={image} alt='students' width={558} height={504} loading='lazy' className='absolute -top-4 right-4'></img>
        </div>
